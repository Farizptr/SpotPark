...
const [modalOpen, setModalOpen] = useState(false);
  ...
  return (
    <>
    <Modal isOpen={modalOpen} onClose={handleCloseModal} boxId={selectedBoxId} boxColor={'#27374D'} />
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex flex-col items-center w-full p-4 mt-8">
        ...
        <div className="flex justify-center w-full">
          <button type="submit" className="mt-4 bg-[#27374D] text-white px-12 py-1 rounded-full" onClick={handleNextClick}>
            Next
          </button>
        </div>
